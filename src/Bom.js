...
function Bom() {
  ...
  function submit(){
    ...
    console.log(data);
    setDoc(doc(db,"products",`${customerId}${Math.floor(Date.now()/100000)}01`), data);
  }
      ...
      <Main>
        <Product>
          ...
          <Form>
            ...
            <Question>
              ...
              <Button
                onClick={() => {
                  setProductQtyList((prev) => [...prev, productQty]);
                }}
              >
                加入
              </Button>
        ...
        <Customers>
          ...
          <Flex>
            ...
            <Button onClick={() => addExistingCustomer()}>Add</Button>
          </Flex>
          <Form>
            <Question>
              <div>公司名稱</div>
              ...
              {partList &&
                partList.map((e) => (
                  <option key={e.id} value={e.id}>
                    {e.name},{e.type},{e.material},{e.finish}
                  </option>
                ))}
            </select>
              ...
              {parts &&
                parts.map((e) => (
                  <tr key={e.id}>
                    ...
                    <Td>{e.material}</Td>
                    <Td>{e.finish}</Td>
                    <Td><Button onClick={()=>{deletePart(e.id)}}>Delete</Button></Td>
                  </tr>
                ))}
            </tbody>
          </Table>
